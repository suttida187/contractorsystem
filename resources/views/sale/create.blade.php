                ...
                <form style="padding:16px;">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="mt-2 d-none" id="otherWork_typeDiv">
                                ...
                                <input name="other_work_type" type="text"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="mt-2 d-none" id="otherSolutionDiv">
                                ...
                                <input name="other_solution" type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <input name="work_description" type="text"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="contact_position" type="text"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="additional_notes" class="form-control @error('additional_notes') is-invalid @enderror"></textarea>
